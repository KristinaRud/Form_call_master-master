	...
	<meta itemprop="inLanguage" content="uk-UA"/>
		...
		<h2 itemprop="name">
								...
								<div id="articleKg" itemprop="articleBody" style="margin:auto;">
									<iframe  align="absmiddle"  id="frameKg" src="https://kyivgaz.ua/forma/Index111.html" frameborder="0" scrolling="no" width="96%" style="overflow: hidden; height:100%"></iframe>
<script>
window.onmessage = function(event){
    if (event.data == 'reply') {
